...
namespace LollyMaui
{
    public static class MauiCommon
    {
        public static async Task GoogleMaui(this string str) =>
            await Browser.OpenAsync($"https://www.google.com/search?q={HttpUtility.UrlEncode(str)}");
        public static async Task SpeakMaui(this SettingsViewModel vmSettings, string text)
        {
