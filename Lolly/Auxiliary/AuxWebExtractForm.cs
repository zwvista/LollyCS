...
namespace Lolly
{
    public partial class AuxWebExtractForm : Form
    {
        ...
        {
            auxList = Program.db.WebExtract_GetData();
        ...
        private void bindingSource1_ListItemDeleted(object sender, ListChangedEventArgs e)
        {
            ...
            Program.db.WebExtract_Delete(deletedSite);
            deletedSite = "";
        }
        ...
        private void dataGridView1_RowValidated(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (currentSite == null)
                Program.db.WebExtract_Insert(row);
            else
                Program.db.WebExtract_Update(row, currentSite);
        }
    }
}
