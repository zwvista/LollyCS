...
{
    public partial class OnlineTextbooksViewModel : ReactiveObject
    {
        public SettingsViewModel vmSettings { get; set; }
        OnlineTextbookDataStore OnlineTextbookDS = new();
        [Reactive]
        public partial int OnlineTextbookFilter { get; set; }
        ...
        [Reactive]
        public partial MOnlineTextbook SelectedOnlineTextbookItem { get; set; }
        [ObservableAsProperty]
        public partial bool HasSelectedOnlineTextbookItem { get; }
        ...
        public OnlineTextbooksViewModel(SettingsViewModel vmSettings, bool needCopy)
        {
            ...
            this.WhenAnyValue(x => x.SelectedOnlineTextbookItem, (MOnlineTextbook v) => v != null).ToProperty(this, x => x.HasSelectedOnlineTextbookItem);
