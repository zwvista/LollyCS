...
namespace LollyCloud
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void AddBlogPostEditTab(string header, MLangBlogPostContent itemBlog)
        {
            Tabs.Add(new ActionTabItem { Header = header, Content = new BlogPostEditControl(itemBlog) });
            tcMain.SelectedIndex = tcMain.Items.Count - 1;
        }
    }
}
