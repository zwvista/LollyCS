...
namespace LollyCloud
{
    ...
    public partial class MainWindow : Window
    {
        ...
        void miUnitBlogPost_Click(object sender, RoutedEventArgs e) => AddPostPostEditTab("Unit Blog", null);
        ...
        public void AddPostPostEditTab(string header, MLangBlogPostContent itemPost)
        {
